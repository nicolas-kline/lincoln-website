...
### Where to put your key and model
...
That is the baked-in app config. At runtime, the Chatbot form can still override these values in your own browser via `localStorage`.

### In-page setup (optional)
